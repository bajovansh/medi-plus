  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
        Medicine <span className="legal-siteSign">+</span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Medicine Plus, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Medicine Plus, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
        Medicine Plus is designed to simplify healthcare access. You can choose
